         ...
         <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb py-2 my-0">
               <li class="breadcrumb-item">
                  <a class="text-main" href="http://localhost/ThanhThuc_2121110112_WED">Trang chủ</a>
               </li>
      ...
      <div class="container">
         <div class="row">
            <div class="col-md-6">
               ...
               <p>Bạn đã có tài khoản chưa ? <a href="index.php?option=customer&login=true">Đăng nhập</a></p>
               ...
               <div class="mb-3">
                  ...
                  <input type="text" name="phone" id="email" value="<?= $customer->email ?>" class="form-control" placeholder="Nhập điện thoại" readonly>
               </div>
               <div class="card-body">
                     <div class="mb-3">
               ...
               <div class="thanhtoan mb-4">
                  ...
                  <div class="p-4 border bankinfo">
                     <p>Ngân Hàng BIDV </p>
                     <p>STK: 56210002342087</p>
                     <p>Chủ tài khoản: Nguyễn Thanh Thức</p>
                  </div>
               </div>
               ...
               <table class="table table-borderless">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                        <img class="img-thumbnail" src="public/images/product/<?= $item['image']; ?>" 
                        alt="<?= $item['image']; ?>">
                        </td>
