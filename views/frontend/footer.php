      ...
      <div class="container">
         <div class="row">
            <div class="col-md-4 pt-4">
               ...
               <p class="pt-1">
                  ThanhThangShop là hệ thống bán sĩ và lẽ thời trang nam, nữ, trẻ em và quần áo thể thao,
                  mong muốn đem đến chất lượng tốt nhất cho khách hàng.
               </p>
               <p class="pt-1">
                  Địa chỉ: 113 Đỗ Xuân Hợp,Phước Long B ,Quận9,TP HCM
               </p>
               <p class="pt-1">
                  Điện thoại: 0985 608 759(call, zalo) - Email: ThanhThangShop.com
               </p>
