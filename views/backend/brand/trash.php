    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-12">
                        <form action="index.php?option=brand&cat=restore" method="post">
                            <select name="action" class="form-control d-inline" style="width:150px;">
                            ...
                            <tr class="datarow">
                                ...
                                <td>
                                    ...
                                    <div class="function_style">
                                        <a href="index.php?option=brand&cat=restore&id=<?= $item->id; ?>">Khôi phục</a> |

                                        <a href="index.php?option=brand&cat=destroy&id=<?= $item->id; ?>">Xoá</a>
                                    </div>
                                </td>
