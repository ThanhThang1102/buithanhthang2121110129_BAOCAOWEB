                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <input type="hidden" id="idcategory" name="idcategory" value="<?= $row['id'] ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="category" name="parent_id" class="form-control">
                                    ...
                                    <?php foreach ($list as $category) : ?>
                                        <option value="<?= $category->id; ?>" <?php echo ($row['parent_id'] == $category->id) ? 'selected' : ''; ?>>
                                            <?= $category->name; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if (!empty($row['image'])) : ?>
                                    <img src="../public/images/category/<?= $row['image']; ?>" alt="Ảnh hiện tại" style="max-width: 100px; max-height: 100px;">
                                <?php endif; ?>
                            </div>
                            <div class="mb-3">
