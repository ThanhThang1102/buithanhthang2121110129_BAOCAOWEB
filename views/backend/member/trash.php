...
$list = User::where($check)->orderBy('created_at', 'DESC')->get();
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-12-md">
                        <form action="index.php?option=member&cat=restore" method="post">
                            ...
                            <tr class="datarow">
                                ...
                                <td>
                                    <div class="function_style">
                                        <a  href="index.php?option=member&cat=restore&id=<?= $item->id; ?>" class="btn btn-sm btn-primary">Khôi phục</a> |

                                        <a  href="index.php?option=member&cat=destroy&id=<?= $item->id; ?>" class="btn btn-sm btn-primary">Xoá</a>
                                    </div>
                                </td>
